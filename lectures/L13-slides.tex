...
\begin{frame}
	...
	The washroom may be locked at such places (usually because they are worried non-customers may use the facilities).
...
\begin{frame}
	...
	If only one thread accesses this data structure, we do not have a problem.
