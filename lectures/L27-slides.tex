...
\begin{frame}
	...
	This returns a pointer to information about the ``next'' easy handle, if there is one.
...
\begin{frame}
	...
	If done, we should look at the return code and the result, in \texttt{m->data.result}.
