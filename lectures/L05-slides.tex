...
\begin{frame}
	...
	Let us modify that code above to fork off a child process that will exit ``abnormally'' with an exit code of 1 in a live demo.
...
\begin{frame}
	...
	Normally a command like \texttt{kill 24601} will send \texttt{SIGTERM} to a process.
	...
	The \texttt{-9} parameter sends signal 9 (\texttt{SIGKILL}) rather than the default (\texttt{SIGTERM}).
