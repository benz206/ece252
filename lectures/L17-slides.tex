...
\begin{frame}
	...
	The problem can have $n$ philosophers, but it is typically described as 5.
...
\begin{frame}
	...
	But the presence of a cycle is not necessarily certainty that there is a deadlock.
