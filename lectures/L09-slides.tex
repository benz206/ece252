...
\begin{frame}
	...
	A UNIX pipe may be given a name on disk.
...
\end{lstlisting}
	...
	\texttt{shmflg}: access permissions (UNIX standards, eg 0600)\\
...
\begin{frame}
    ...
    No - it's only possible to attach to memory segments of your own processes or those where the permission bits allow it.
...
\begin{frame}
	\frametitle{Alternative: \texttt{mmap()}}
...
\begin{frame}
	...
	Valid values are \texttt{PROT\_NONE}, \texttt{PROT\_READ}, \texttt{PROT\_WRITE}, and \texttt{PROT\_EXEC}.
