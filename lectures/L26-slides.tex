...
\begin{frame}
	...
	If one thread gets blocked on the I/O the other ones can continue and are fine.
...
\end{lstlisting}
	...
	So, seconds and nanoseconds instead of seconds and microseconds.
...
\end{lstlisting}
	...
	\texttt{nfds}: number of items in the array.
