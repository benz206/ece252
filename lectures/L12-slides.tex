...
\begin{frame}
	...
	If a computer only ever did exactly one thing at a time we would have no concurrency and therefore no co-ordination problems.
...
\begin{frame}
	...
	If we have multiple processors, disabling interrupts will not be sufficient.
