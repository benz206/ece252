...
\begin{frame}
	...
	In the trivial version, the host tells the contestants whose turn it is.
...
\begin{frame}
	...
	As you will recall from basic chemistry, water, H$_{2}$O, requires two hydrogen atoms and one oxygen atom.
...
\begin{frame}
	...
	The barrier from earlier has also been converted into C code.
...
\begin{frame}
	...
	As the chemical composition of water has one oxygen, the job is assigned to this atom.
