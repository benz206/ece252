...
\begin{frame}
	\frametitle{Hey GCC, Could You Please...}

The GCC compiler provides operations that are guaranteed to execute atomically, to avoid simple race conditions
...
\begin{frame}
	...
	These are, however, GCC specific, and not necessarily available or portable.
	...
	A valid type is 1, 2, 4, or 8 bytes in length (integral or pointer).
