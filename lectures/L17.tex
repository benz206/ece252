...
But the presence of a cycle, on its own, is not necessarily certainty that there is a deadlock:
...
This isn't really something we can do as program designers, because only the operating system really has the power to carry this out. It's included for completeness, but is not anything we can actually implement ourselves.
